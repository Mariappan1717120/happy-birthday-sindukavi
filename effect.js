...
$('document').ready(function(){
	...
	setTimeout(turnOnLights, 1000);
    setTimeout(playAudio, 3000);
    setTimeout(showBanner, 5000);
	setTimeout(balloonsFly,7000);
	setTimeout(cake,10000);
	setTimeout(lightCandle,12000);
	setTimeout(wish,14000);
	setTimeout(story,17000);
});
